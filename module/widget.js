    ...
    music163: {
        ...
        update: () => {
            $('.wg.music163>.content').html(
                ...
                <p class="text">2.通过<a onclick="window.open('https://https://stxttkx.github.io/netease-music-search','_blank');“win12_title="网易云音乐搜索" class="jump">音乐搜索网站</a>获取音乐 ID</p>
                <input type="text" id="music163-input" placeholder="3.粘贴音乐 ID，回车确认" onkeydown="goMusic(event)">`
            )
